...
class booking_function
{
    ...
    public function findSpecificBranchBooking($branch_id)
    {
        ...
        tb_booking.selected_time, tb_booking.service_id, tb_booking.booking_id, tb_booking.provider_id, tb_booking.service_title, tb_booking.service_description, tb_customer.remark, tb_customer.name ,tb_customer.customer_id, tb_customer.contact, tb_customer.email, tb_service.color FROM tb_booking JOIN tb_service 
    ...
    public function findAllBranchBooking($company_id)
    {
        ...
        tb_booking.booking_id, tb_booking.provider_id, tb_booking.service_title, tb_booking.service_description, tb_branch.branch_id, tb_customer.remark,tb_customer.name ,tb_customer.customer_id, tb_customer.contact, tb_customer.email, tb_service.color   FROM tb_booking JOIN tb_service ON tb_booking.service_id = tb_service.service_id JOIN
    ...
    {
        $stmt = $this->conn->prepare("SELECT tb_booking.updated_at,tb_booking.created_at, tb_booking.status, tb_booking.customer_id, tb_booking.selected_date, 
        ...
        JOIN tb_branch ON tb_service.branch_id = tb_branch.branch_id 
