 ...
 * create
 * */
else if (isset($_POST['create']) && isset($_POST['break_time']) && isset($_POST['slot']) && isset($_POST['work_time']) && isset($_POST['work_day']) && isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['staff_description']) && isset($_POST['name'])) {
    $create = $db->create(array($created_at, $_POST['break_time'], $_POST['slot'], $_POST['work_time'], $_POST['work_day'], $_POST['email'], $_POST['phone'], $_POST['staff_description'], $_POST['name']));
